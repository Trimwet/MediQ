    ...
    <div className='pb-24'>
      ...
      <section className='bg-muted/40 py-24'>
        <div className='mx-auto max-w-6xl px-4 sm:px-6'>
          <div className='max-w-3xl'>
            ...
            <h1 className='font-manrope text-4xl font-bold tracking-tight mb-4 leading-tight sm:text-5xl'>
              Dedicated to Your{' '}
      ...
      <section className='mx-auto max-w-6xl px-4 sm:px-6 py-24'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          <div>
            <h2 className='font-manrope text-3xl sm:text-4xl font-semibold tracking-tight mb-8'>
            ...
            <div className='space-y-6 text-muted-foreground text-lg leading-relaxed'>
              ...
              <div className='grid grid-cols-2 gap-4 pt-6'>
                <div className='rounded-2xl border border-border bg-card p-5 shadow-sm'>
                  ...
                  <div className='mt-3 text-2xl font-bold text-foreground'>150+</div>
                ...
                <div className='rounded-2xl border border-border bg-card p-5 shadow-sm'>
                  ...
                  <div className='mt-3 text-2xl font-bold text-foreground'>50k+</div>
                  <div className='text-xs font-semibold uppercase tracking-wider text-muted-foreground'>
                    Happy Patients
                  </div>
                </div>
          ...
          <div className='relative'>
            ...
            />
            <div className='absolute -bottom-8 -left-8 rounded-2xl border border-border bg-card p-6 shadow-lg hidden md:block'>
      ...
      <section className='bg-muted/40 py-20'>
        <div className='mx-auto max-w-6xl px-4 sm:px-6'>
          ...
          <h2 className='font-manrope text-2xl sm:text-3xl font-semibold tracking-tight text-center mb-4'>
            Our Values
          </h2>
